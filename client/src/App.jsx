...
const style = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .nav-tab {
    ...
    color: var(--muted); font-family: 'DM Mono', monospace; font-size: 13px; cursor: pointer; transition: all 0.2s;
  }
  .nav-tab:hover { color: var(--text); background: var(--card); }
  .nav-tab.active { color: var(--accent); background: var(--card); }
  .nav-right { display: flex; gap: 10px; align-items: center; }
  .badge { background: var(--accent); color: #000; font-size: 11px; padding: 4px 10px; border-radius: 20px; }
  .btn { padding: 9px 20px; border-radius: var(--radius); border: none; cursor: pointer; font-family: 'DM Mono', monospace; font-size: 13px; font-weight: 500; transition: all 0.2s; }
  ...
  .hero { text-align: center; padding: 80px 20px 60px; background: radial-gradient(ellipse at 50% 0%, #f0c04015 0%, transparent 70%); }
  ...
  .how-card p { color: var(--muted); font-size: 12px; line-height: 1.7; }
  ...
  .filter-pill { padding: 6px 14px; border-radius: 20px; border: 1px solid var(--border); background: transparent; color: var(--muted); font-family: 'DM Mono', monospace; font-size: 12px; cursor: pointer; transition: all 0.2s; }
  .filter-pill.active, .filter-pill:hover { border-color: var(--accent); color: var(--accent); }
  .filter-spacer { flex: 1; }
  .search-box { background: var(--card); border: 1px solid var(--border); border-radius: var(--radius); padding: 9px 16px; color: var(--text); font-family: 'DM Mono', monospace; font-size: 13px; width: 220px; outline: none; }
  ...
  .listing-card:hover { border-color: var(--accent); transform: translateY(-2px); box-shadow: 0 8px 32px #f0c04015; }
  ...
  .listing-desc { color: var(--muted); font-size: 12px; line-height: 1.6; margin-bottom: 16px; }
  ...
  .timer { font-size: 12px; color: var(--muted); display: flex; align-items: center; gap: 4px; }
  ...
  .form-label { display: block; font-size: 11px; color: var(--muted); text-transform: uppercase; letter-spacing: 1px; margin-bottom: 8px; }
  .form-input, .form-textarea, .form-select { width: 100%; background: var(--card); border: 1px solid var(--border); border-radius: var(--radius); padding: 12px 16px; color: var(--text); font-family: 'DM Mono', monospace; font-size: 13px; outline: none; transition: border 0.2s; }
  ...
  .status-open { background: #f0c04020; color: var(--accent); }
  .status-closed { background: #4ade8020; color: var(--green); }
  .status-pending { background: #e05a5a20; color: var(--accent2); }
  ...
  .sub-tab { padding: 10px 20px; font-family: 'DM Mono', monospace; font-size: 13px; cursor: pointer; border: none; background: none; color: var(--muted); border-bottom: 2px solid transparent; margin-bottom: -1px; }
