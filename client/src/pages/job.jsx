    ...
    <div className="max-w-4xl mx-auto px-4 py-20">
      <div className="card">
        ...
        <div className="grid md:grid-cols-2 gap-8 mb-8">
          <div>
            <h3 className="text-gray-400 text-sm uppercase mb-2">Budget</h3>
            <p className="text-3xl font-bold text-accent">${selectedJob.budget}</p>
          </div>
          <div>
            <h3 className="text-gray-400 text-sm uppercase mb-2">Category</h3>
          ...
          <div>
            ...
            <div className="space-y-3">
              {selectedJob.bids.map((bid) => (
                <div key={bid._id} className="bg-gray-800 p-4 rounded-lg flex justify-between items-center">
                  <div>
                    <p className="font-semibold">{bid.seller_id?.name}</p>
                    <p className="text-sm text-gray-400">{bid.note}</p>
                  </div>
